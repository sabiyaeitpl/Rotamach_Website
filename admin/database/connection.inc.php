...
//local setup
$con = mysqli_connect("localhost","rotam6x1_admin","Rotamech@2023","rotam6x1_website");
define('SERVER_PATH',$_SERVER['DOCUMENT_ROOT'].'/rotamechnew/');
define('SITE_PATH','https://www.rotamech.com/rotamechnew/');
