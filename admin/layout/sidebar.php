        ...
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="#data">
                            <i class="iconsminds-data-center"></i> Website Data
                        </a>
                    </li>
                    <li>
                        <a href="products.php">
                     ...
                     <li>
                        <a href="job_type.php">
                        <i class="simple-icon-grid"></i>Job Type
                        </a>
                    </li>
                    <li>
                        <a href="#design">
        ...
        <div class="sub-menu">
            <div class="scroll">
                ...
                <ul class="list-unstyled" data-link="data">
                    <li>
                        <a href="career.php">
                            <i class="simple-icon-picture"></i> <span class="d-inline-block">Career Application</span>
                        </a>
                    </li>
                    <li>
                        <a href="enquiry.php">
                            <i class="simple-icon-check"></i> <span class="d-inline-block">Enquiry List</span>
                        </a>
                    </li>
                    <li>
                        <a href="joinus.php">
