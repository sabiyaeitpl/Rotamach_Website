                ...
                <nav class="navbar navbar-expand-lg navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                    ...
                    <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="about_us.php" class="nav-item nav-link <?php echo $about ?>">About Us</a>
                            <div class="nav-item dropdown">
                                <a href="products.php" class="nav-link <?php echo $product ?> dropdown-toggle" data-toggle="dropdown">Products</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                 ...
                                 <a href="clients.php" class="nav-item nav-link <?php echo $client ?>">Clients</a>
                            <a href="design.php" class="nav-item nav-link <?php echo $design ?>">Design</a>
                            <a href="#" class="nav-item nav-link" data-toggle="modal"
                                data-target="#exampleModal">Career</a>
                            <a href="#" class="nav-item nav-link" data-toggle="modal"
                                data-target="#exampleModal2">Enquiry</a>
                            <a href="contact_us.php" class="nav-item nav-link <?php echo  $contactus ?>">Contact Us</a>
                        </div>
                    </div>
                </nav>
            </div>
