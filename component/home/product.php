        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col text-center mb-4">
                    ...
                    <h1 class="mb-4 bold">More Products</h1>
                </div>
            </div>
            <div class="row pb-3">
            <?php
            ...
            ?>
                <div class="col-md-3">
                    ...
                    <div class="card border-0 mb-2 shadow-sm">
                       <div class="product_img_main"><img class="card-img-top" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$row_product['image'] ?>" alt="<?php echo $row_product['name'] ?>"></div>
            ...
            <div class="text-center"><a href="products.php" class="btn btn-danger py-md-3 px-md-5">View Our Product</a></div>
        </div>
    </div>